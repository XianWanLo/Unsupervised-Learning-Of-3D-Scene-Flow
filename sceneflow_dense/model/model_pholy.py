...
class ESBFlow(nn.Module):
    ...
    def forward(self, pos1_bhw3, pos2_bhw3, color1, color2, intrinsics, occ_mask , label=None, train=False, warped=False):
       ...
       ##################  the l1 select xyz, label    ##################################
        ...
        pc1_sample = [l0_xyz_f1_raw, l1_xyz_f1_raw, l2_xyz_f1_raw, l3_xyz_f1_raw]
        pc2_sample = [l0_xyz_f2_raw, l1_xyz_f2_raw, l2_xyz_f2_raw, l3_xyz_f2_raw]
        flow_list = [ l0_flow, l1_flow, l2_flow, l3_flow]
        mask_list = [ l0_occ_mask.reshape(batch_size, -1), l1_occ_mask.reshape(batch_size, -1), l2_occ_mask.reshape(batch_size, -1), l3_occ_mask.reshape(batch_size, -1)]
        ...
        height_list = [self.out_H_list[0], self.out_H_list[1], self.out_H_list[2], self.out_H_list[3], self.out_H_list[4] ] 
        width_list  = [self.out_W_list[0], self.out_W_list[1], self.out_W_list[2], self.out_W_list[3], self.out_W_list[4] ]
